# Database Selection for Amphora Multi-Tenant Architecture

## Executive Summary

For a scalable, multi-tenant object storage service like Amphora, **PostgreSQL** is the recommended primary database choice. Redis complements it for caching and session management.
