...
An on-premise, S3-compatible object storage service written in Go. Amphora
...
![Amphora component architecture](specs/architecture.png)
...
| `make build`       | Compile the `amphora` binary                           |
