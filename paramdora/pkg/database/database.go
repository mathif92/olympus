// Package database provides the PostgreSQL access layer for Paramdora.
// It handles connection pooling and multi-tenant parameter data access.
package database
...
func NewClient(cfg Config) (*Client, error) {
	...
	// Retry briefly to tolerate databases that are still warming up.
